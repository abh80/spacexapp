      ...
      <div className="basePage">
        ...
        <Router>
          <Switch>
            ...
            <Route exact={true} path="/rocket" component={Rocket} />
            <Route exact path="/error" component={error} />
            <Route exact path="/launch" component={launchComponent} />
...
const error = () => {
  return (
    <div style={{ margin: "auto", textAlign: "center" }}>
      <u>
        <h1>Backend Downlink</h1>
      </u>
      <h2>
        Uh oh... Looks like something really went wrong while connecting to the
        Backend. <br />
